    ...
    <form name="form2" method="post" action="UserServlet?action=login" >  
        <table width="240" height="276" align="center" cellspacing="5" >  
            ...
            <tr>  
              ...
              <input type="button" class="btn btn-block btn-primary" value="登录" onClick="check(this.form)"/></td>
            </tr>
			<tr>
			  <td height="22" colspan=""><div align="center"><a href="register.jsp">注册</a></div></td>
			</tr>
      </table> 
    </form>  
</body>  
